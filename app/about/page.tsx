    ...
    <div className="flex flex-col gap-16">
      ...
      <section className="space-y-6 text-base text-brand-secondary">
        ...
        <div>
          ...
          <p className="mt-2">
            Reach out via the <Link href="/contact" className="underline-offset-4 hover:underline text-brand-primary">contact form</Link> or join the mailing list for updates.
          </p>
        </div>
      </section>
