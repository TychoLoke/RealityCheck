...
export default function HomePage() {
  return (
    <div className="flex flex-col gap-28 pb-12">
      <section className="space-y-14 rounded-3xl bg-brand-muted p-10 sm:p-16 lg:p-20">
        ...
        <div className="space-y-8">
          ...
          <h1 className="max-w-3xl text-5xl font-semibold leading-tight text-brand-primary sm:text-6xl">
            A home for the channel to design what comes next.
          </h1>
          <div className="max-w-3xl space-y-5 text-base leading-relaxed text-brand-secondary sm:text-lg">
            <p>
            ...
            <p>
              We’re building it in the open with the people already in the trenches—codifying the rituals that work, cutting what doesn’t, and telling the story of the channel’s next era together.
            </p>
          </div>
        </div>
      ...
      <section className="grid gap-12 rounded-3xl border border-zinc-200 bg-white p-10 shadow-md shadow-brand-primary/5 lg:grid-cols-[1.2fr_1fr] lg:p-14">
        <div className="space-y-8">
          ...
          <ol className="space-y-7">
            {[
              ...
              <li key={item.title} className="rounded-[16px] border border-brand-muted bg-brand-muted/60 p-5">
                <p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand-secondary">{item.title}</p>
                <p className="mt-3 text-base leading-relaxed text-brand-primary">{item.detail}</p>
              </li>
            ))}
          </ol>
        </div>
        <div className="space-y-6 rounded-[20px] bg-brand-muted p-8 lg:p-10">
      ...
      <section className="space-y-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {[
            ...
            <div
              key={item.title}
              className="space-y-4 rounded-[16px] border border-zinc-200 bg-white p-6 shadow-sm shadow-brand-primary/5"
            >
