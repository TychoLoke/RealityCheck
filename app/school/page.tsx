    ...
    <div className="flex flex-col gap-12">
      <section className="border-b border-white/10 bg-graphite/70 py-16 sm:py-20">
        <Container className="flex flex-col gap-6">
          ...
          <h1 className="text-3xl font-semibold text-white sm:text-4xl">Start where careers begin: Channel 101.</h1>
          <p className="max-w-3xl text-base leading-relaxed text-neutral sm:text-lg">
            ...
            It’s free to start, practical from day one, and built with the companies who will hire you.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            <CTAButton href="/apply">Apply to the Deurne cohort</CTAButton>
            <CTAButton href="#watch" variant="secondary">
              Watch Channel 101
            </CTAButton>
            <CTAButton href={process.env.NEXT_PUBLIC_DISCORD_URL ?? "https://discord.gg/your-invite"} variant="ghost" className="text-neutral hover:text-accentTeal">
              Join the community
            </CTAButton>
          </div>
        </Container>
      ...
      <Section title="Apply" description="Secure your spot in the next Deurne cohort." columns={1}>
        <Embed
      ...
      <section className="pb-20">
        <Container className="flex flex-col items-center gap-4 rounded-3xl border border-white/10 bg-graphite/70 px-8 py-10 text-center shadow-card">
          <h2 className="text-2xl font-semibold text-white">Learn. Work. Win.</h2>
