    ...
    <header className="sticky top-0 z-40 border-b border-midnight/10 bg-cloud/90 backdrop-blur-xl">
      <Container className="flex items-center justify-between py-4">
        ...
        <nav aria-label="Primary" className="hidden items-center gap-8 text-sm font-medium text-neutral lg:flex">
          ...
          <CTAButton href="/apply" className="text-sm font-semibold">
            Apply
          </CTAButton>
        </nav>
        <div className="flex items-center gap-3 lg:hidden">
          <CTAButton href="/apply" className="hidden text-xs font-semibold sm:inline-flex">
            Apply
          </CTAButton>
          <button
            type="button"
      ...
      >
        <Container className="flex flex-col gap-4 py-4 text-sm font-medium text-neutral">
          ...
          <CTAButton href="/apply" className="justify-center text-sm font-semibold">
            Apply
          </CTAButton>
        </Container>
      </div>
